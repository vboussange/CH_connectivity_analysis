...
dataset_path = joinpath(@__DIR__, "../../../data/GUILDS_EU_SP/GUILDS_EU_SP_buffer_dist=50km_resampling_8.nc")
θ = 0.1

α = 75 # movement capability, TODO: to be extracted from TraitsCH
